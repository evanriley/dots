...
alias dots = git --git-dir=(echo $env.HOME)/.dots/ --work-tree=(echo $env.HOME)
...
let light_theme = {
    ...
    block: "#605A52"      
    hints: "#7F7A73"      
    search_result: { fg: white bg: "#8F5652" }
    shape_and: purple_bold
    shape_binary: purple_bold
    shape_block: blue_bold
    ...
    shape_custom: "#747B4D"        
    shape_datetime: cyan_bold
    shape_directory: "#556995"     
    shape_external: "#556995"      
    shape_externalarg: green_bold
    shape_external_resolved: "#886A44"  
    shape_filepath: "#556995"      
    shape_flag: blue_bold
    shape_float: purple_bold
    shape_garbage: { fg: white bg: "#8F5652" attr: b }  
    shape_string: "#747B4D"        
    shape_string_interpolation: cyan_bold
    shape_table: blue_bold
    shape_variable: purple
