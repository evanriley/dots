...
keymap('n', "<leader>fl", function() require('mini.pick').builtin.hl_groups() end)
keymap('n', "<leader>bb", function() require('mini.pick').builtin.buffers() end)
...
-- [[ LSP Keymaps ]]
keymap("n", "<leader>gd", function() vim.lsp.buf.definition() end)
keymap('n', "K", function() vim.lsp.buf.hover() end)
keymap("n", "<leader>ls", "<cmd>Pick lsp scope='document_symbol'<cr>")
keymap("n", "<leader>gr", function() vim.lsp.buf.rename() end)
